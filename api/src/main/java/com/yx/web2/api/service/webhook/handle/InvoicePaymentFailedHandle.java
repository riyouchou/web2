...
@Service(WebHookEventType.INVOICE_PAYMENT_FAILED)
@RequiredArgsConstructor
public class InvoicePaymentFailedHandle implements IWebHookHandler {
    ...
    public ResponseEntity<?> handle(StripeObject stripeObject) {
        ...
        KvLogger kvLogger = KvLogger.instance(this)
                ...
                .p(LogFieldConstants.ACTION, WebHookEventType.INVOICE_PAYMENT_FAILED)
